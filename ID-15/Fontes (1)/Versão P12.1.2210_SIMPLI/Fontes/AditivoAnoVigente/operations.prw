                        ...
                        Do Case
                            ...
                            Case AllTrim(Upper(oObjJSON:OPERATIONS[nI]:eventType)) == "SOLD"
                                ...
                                */
                                ...
                                nValLiq := ((SE2->E2_VALOR + SE2->E2_ACRESC + SE2->E2_MULTA + SE2->E2_JUROS) - (IIf(AllTrim(GETSPARAM('MV_MRETISS')) == '1', (SE2->E2_COFINS + SE2->E2_PIS + SE2->E2_CSLL + SE2->E2_DESCONT + SE2->E2_DECRESC), (SE2->E2_ISS + SE2->E2_COFINS + SE2->E2_PIS + SE2->E2_CSLL + SE2->E2_DESCONT + SE2->E2_DECRESC))))
                                ...
                                If lReturn
                                    ...
                                    Else
                                        ...
                                        cFatura	:= Soma1(GETSPARAM("MV_NUMFATP"))
                                        ...
                                        GETSPARAM("MV_NUMFATP")
                                        //RecLock("SX6", .F.)
                                            PUTMV("MV_NUMFATP",cFatura) //SX6->X6_CONTEUD := cFatura
                                        //SX6->(MSUnLock())
                                        ...
                                        If lMSErroAuto
                                            ...
                                            SE2->(DBSelectArea("SE2"))
                                            SE2->(DBSetOrder(1))
                                            If SE2->(MSSeek(FWxFilial("SE2") + cPrefixo + cFatura))
                                                lIgnoraErro := .T.
                                            Else
                                                lIgnoraErro := .F.
                                            EndIf
                                        ...
                                        If lMSErroAuto .And. !lIgnoraErro
