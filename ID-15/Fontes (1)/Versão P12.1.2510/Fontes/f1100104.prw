...
User Function F1100104()
	...
	Local aPergs 		:= {}
	Local oReport		:= Nil
	Local lExistPergunte := .F. //Thiago Marques - ticket nº 23781643 -  13/06/2025 - Adição de variável para compatibilização.

	Private cPerg  := "FSW1100401"
	Private aAnswers:= {}
	
	//ValidPerg(cPerg) Thiago Marques - ticket nº 23781643 -  13/06/2025 - Removido para compatibilização.

	//validando se o grupo de perguntas existe
	lExistPergunte := FWSX1Util():ExistPergunte(cPerg)
	...
	if lExistPergunte
		...
		FWAlertWarning("Grupo de perguntas não existe.","Atenção")
	EndIf
