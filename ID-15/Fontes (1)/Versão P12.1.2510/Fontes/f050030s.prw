...
Static Function VldTransf( aCpos )
	...
	If lTransf
		...
		If nScan > 0
			...
			//Campos excluidos da tabela pela RedDor							   
...
// Ticket No. 4494084 - 418497 - Don Junior - correção variable does not exist LTPDESL on FMONTAHEADER(GPEA180.PRX) 
	...
	Private cConPeriod	:= .F. //correção variable does not exist CCONPERIOD on FTELATRANSF(GPEXTRF.PRW) Thais Paiva - 24481856
	Private cConNrPag	:= .F. //correção variable does not exist CCONNRPAG on FTELATRANSF(GPEXTRF.PRW) Thais Paiva - 24481856
