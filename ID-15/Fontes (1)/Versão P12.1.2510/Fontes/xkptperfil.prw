...
Static Function MenuDef()
	...
	Aadd(aRot , {"Visualizar"    ,'VIEWDEF.xKPTPerfil'       , 0, 1})
	Aadd(aRot , {"Incluir"    , 'VIEWDEF.xKPTPerfil'       , 0, 3})
	Aadd(aRot , {"Alterar"    , 'VIEWDEF.xKPTPerfil'        , 0, 4})
	Aadd(aRot , {"Excluir"    , 'VIEWDEF.xKPTPerfil'        , 0, 5})
	Aadd(aRot , {"Copiar"    , 'VIEWDEF.xKPTPerfil'        , 0, 9})
