			...
			If lContinua
				...
				If !( cAliasCr )->( Eof() )
					...
					While !( cAliasAl )->( Eof() )
						...
						cFornece := Posicione("CNA",1,CND->CND_FILCTR+AllTrim(CND->CND_CONTRA)+CND->CND_REVISA,"CNA_FORNEC")
						cLojaFor := Posicione("CNA",1,CND->CND_FILCTR+AllTrim(CND->CND_CONTRA)+CND->CND_REVISA,"CNA_LJFORN")
