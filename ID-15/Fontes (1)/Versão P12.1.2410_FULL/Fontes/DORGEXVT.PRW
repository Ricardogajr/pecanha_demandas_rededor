...
aAdd( aPergs ,{1,"Localidade        : ",space(TAMSX3("RGC_KEYLOCK")[1]),"@!",'.T.','RGC','.T.',TAMSX3("RGC_KEYLOCK")[1],.F.}) //aAdd( aPergs ,{1,"Localidade        : ",space(03),"@!",'.T.','RGC','.T.',03,.F.})
...
If nArqAPS <  0 .OR. !File(cArqAPS) //Thais Paiva - 24284998
