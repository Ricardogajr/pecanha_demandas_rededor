...
User Function F0100306()
	...
	WEB EXTENDED INIT cHtml START "InSite"
		...
		If oOrg:GetStructure()
			...
			oSolic:oWSSolicitVag:cJusVaga     := HttpPost->ddJusVaga
			oSolic:oWSSolicitVag:cSolComp     := HttpPost->ddSolComp
			
			
			if HttpGet->cFlPEsc $ "01310108|01310011"
				oSolic:oWSSolicitVag:cLocali     := HttpPost->ddLocali

				if AllTrim(oSolic:oWSSolicitVag:cLocali) == "4"
					oSolic:oWSSolicitVag:cXOutros     := HttpPost->cXOutros
				endif			
			endif
