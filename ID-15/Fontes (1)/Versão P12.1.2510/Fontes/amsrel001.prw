...
Static Function PrintReport(oReport)
	...
	cQuery += " SELECT	DISTINCT(P00_FILIAL||P00_NUM||P00_PREFIX||P00_FORNEC||P00_LOJAF) AS CHVE, "
	...
	Else
		...
		Do While (cAlQry)->(!Eof())
			...
			If aScan(aRegs,( cAlQry )->CHVE) == 0
				AADD(aRegs,(cAlQry)->CHVE)
				lInclui := fValidaP00()
				If lInclui
...
Static Function fQtdRec()
	...
	cQuery += " AND P00_FILIAL||P00_NUM||P00_PREFIX||P00_FORNEC||P00_LOJAF = '"+( cAlQry )->CHVE+"'"
