...
Static Function MenuDef()
	...
	Aadd(aRot , {"Manutenção"    ,'VIEWDEF.FCADP53'       , 0, 1})
	Aadd(aRot , {"Selecione"    , 'VIEWDEF.FCADP53'       , 0, 3})
	Aadd(aRot , {"Carga"    , 'VIEWDEF.FCADP53'        , 0, 4})
	Aadd(aRot , {"Excluir"    , 'VIEWDEF.FCADP53'        , 0, 5})
