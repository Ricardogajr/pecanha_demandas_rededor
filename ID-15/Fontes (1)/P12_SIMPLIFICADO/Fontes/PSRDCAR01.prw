...
Static function geraSP()
	...
	While (cAliasSE2)->(!Eof())
		...
		If SE2->(DbSeek(cChave))
			...
			aAdd(aCabec, {"C7_COND"   , SuperGetMV("MV_XCONDSP",, "001"), Nil})
			AAdd(aCabec, {"C7_XTIPO",   Padr(SuperGetMv("MV_XTPRIMP",,"HML"), TamSx3("C7_XTIPO")[01]), Nil})
			...
			cProduto := superGetMV("MV_XPRDEST",,"")
