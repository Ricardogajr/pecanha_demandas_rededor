...
/*/{Protheus.doc} User Function FA300REJ
    Ponto na rejeição do arquivo de retorno bancário
    @type  Function
    @author Gianluca Moreira
    @since 20/05/2021
    @see https://tdn.totvs.com/pages/releaseview.action?pageId=6071204
    /*/
User Function FA300REJ()
    ...
    If lGrpHblt
        //U_F2000100('SE2', REJBAN_PREV) //Grava registro previsto na PX0 - envio ao XRT
        //U_F2000100('SE2', REJBAN_REAL) //Grava registro realizado na PX0 - envio ao XRT
        U_F2000110(.F.) //Limpa Flag de envio bancário
    EndIf    
