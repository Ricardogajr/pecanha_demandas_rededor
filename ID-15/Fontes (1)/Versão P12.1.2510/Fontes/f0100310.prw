...
User Function F0100310()
	...
	WEB EXTENDED INIT cHtml START "InSite"
		...
		If oSol:oWSBscSolVagsRESULT:cRet == ".T."
			...
			//cJusVaga     := oSol:oWSBscSolVagsRESULT:cJusVaga
			...
			//cSolComp     := oSol:oWSBscSolVagsRESULT:cSolComp
			cSolComp     := IIF(AllTrim(oSol:oWSBscSolVagsRESULT:cSolComp) == "1", "Sim", "Não")
						
			if Alltrim(cFVaga) $ "01310108|01310011"
				...
				//cLocali := oSol:oWSBscSolVagsRESULT:cLocali
				ddLocali := oSol:oWSBscSolVagsRESULT:cLocali
				if AllTrim(ddLocali) == "4"  //AllTrim(ddLocali) == "4"
					cXOutros     := oSol:oWSBscSolVagsRESULT:cXOutros
				else
					cXOutros     := IIF(Empty(Alltrim(oSol:oWSBscSolVagsRESULT:cXOutros)), "", Alltrim(oSol:oWSBscSolVagsRESULT:cXOutros))
				endif			
			endif
