...
#include "topconn.ch"
///////////////////////////////////////////////////
// CARGA NA TABELA SRA PROTHEUS 12 VIA PLANILHA. //
///////////////////////////////////////////////////
***********************
User Function UPD0222()
***********************
    ...
    Define MsDialog oDlg Title "UPD0222 - Selecionar Arquivo para Carga" From 08,15 To 19,120 Of GetWndDefault()
...
*********************************
	...
	//////////////////////////////////////////////////////////
	// COLUNA A = FILIAL                      RA_FILIAL	    //1
	// COLUNA B = NOME FILIAL                 XXXXXXXXX     //2
	// COLUNA C = MATRICULA                   RA_MAT        //3
	// COLUNA D = NOME FUNCIONARIO            RA_NOME       //4
    // COLUNA E = POSTO                       RA_POSTO	    //5
	//////////////////////////////////////////////////////////
	...
	For i:=1 to Len(aDados)
	    ...
	    if len(aDados[i,1]) > 0
           c_Mat    := PADL(aDados[i,3],TamSX3("RA_MAT")[1],"0")
		   n1       := TamSX3("RA_MAT")[1]
           c_Mat    := Strzero(Val(c_mat),N1,0)
           c_Posto  := PADL(aDados[i,5],TamSX3("RA_POSTO")[1],"0")
		   n1       := TamSX3("RA_DEPTO")[1]
		   c_Posto  := strzero(val(c_Posto),N1,0)
	...
	If !Empty(aRetorno)
		Aviso('Processamento Realizado!',"Verifique o log da importação \SPOOL\UPD0222.CSV", {'OK'}, 1)
        Geralog(aRetorno)
	EndIf
...
cMsg := "UPD0222 LOG DE PROCESSO"+CRLF
