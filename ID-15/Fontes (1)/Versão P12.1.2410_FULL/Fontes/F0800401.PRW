...
Static Function MenuDef()
	...
	//ADD OPTION aRotina TITLE "Automatico"    ACTION "U_F0800404()"     OPERATION 4 ACCESS 0
		aRotina:={{"Visualizar"						,"VIEWDEF.F0800401"				,0,2},;
				  {"Incluir"						,"VIEWDEF.F0800401"				,0,3},;
				  {"Alterar"						,"VIEWDEF.F0800401"				,0,4},;
				  {"Excluir"						,"VIEWDEF.F0800401"				,0,5},;
				  {"Copiar alçada"					,"VIEWDEF.F0800401"				,0,9},;
				  {"Automatico"						,"U_F0800404()"					,0,4}}
Return aRotina
