	...
	Local _cRetUpd
		...
		If !(_cRetUpd==0) 
			...
			if !lNMenu
				...
				APMsgAlert(AllTrim(_cRetUpd),"Atualização de validação de filial não realizada!")
		...
		If !(_cRetUpd==0) 
			...
			if !lNMenu
				...
				APMsgAlert(AllTrim(_cRetUpd),"Atualização de validação de TM não realizada!")
		...
		If !(_cRetUpd==0) 
			...
			if !lNMenu
				...
				APMsgAlert(AllTrim(_cRetUpd),"Atualização de validação de código de produto não realizada!")
		...
		If !(_cRetUpd==0) 
			...
			if !lNMenu
				...
				APMsgAlert(AllTrim(_cRetUpd),"Atualização de validação de unidade de medida não realizada!")
		...
		If !(_cRetUpd==0) 
			...
			if !lNMenu
				...
				APMsgAlert(AllTrim(_cRetUpd),"Atualização de validação de quantidade não realizada!")
       ...
       //6.Validando se o armazém existe
		...
		If !(_cRetUpd==0) 
			...
			if !lNMenu
				...
				APMsgAlert(AllTrim(_cRetUpd),"Atualização de validação de local de armazém não realizada!")
		...
		If !(_cRetUpd==0) 
			...
			if !lNMenu
				...
				APMsgAlert(AllTrim(_cRetUpd),"Atualização de validação de Data de Emissão não realizada!")
		...
		If !(_cRetUpd==0) 
			...
			if !lNMenu
				...
				APMsgAlert(AllTrim(_cRetUpd),"Atualização de validação de Centro de Custo não realizada!")
		...
		If !(_cRetUpd==0) 
			...
			if !lNMenu
				...
				APMsgAlert(AllTrim(_cRetUpd),"Atualização de validação de Número do Documento não realizada!")
		...
		If !(_cRetUpd==0) 
			...
			if !lNMenu
				...
				APMsgAlert(AllTrim(_cRetUpd),"Atualização de validação do Item não realizada!")
	...
	/*	     				
		...
		If !(_cRetUpd==0) 
			...
			if !lNMenu
				...
				APMsgAlert(AllTrim(_cRetUpd),"Atualização de validação da Conta Contábil não realizada!")
		...
		*/
		...
		If !(_cRetUpd==0) 
			...
			if !lNMenu
				...
				APMsgAlert(AllTrim(_cRetUpd),"Atualização de validação do grupo do produto não realizada!")
		...
		If !(_cRetUpd==0) 
			...
			if !lNMenu
				...
				APMsgAlert(AllTrim(_cRetUpd),"Atualização de validação do tipo do produto não realizada!")
		...
		If !(_cRetUpd==0) 
			...
			if !lNMenu
				...
				APMsgAlert(AllTrim(_cRetUpd),"Atualização de validação da duplicidade não realizada!")
...
/*		cUpdAtu	+= "						  AND VLDD3_CONTA <> ' ' "+CRLF		//1 espaço 
		...
		If !(_cRetUpd==0) 
			...
			if !lNMenu
				...
				APMsgAlert(AllTrim(_cRetUpd),"Atualização de validação da total de cada linha não realizada!")
		...
		Else
			...
			If !(_cRetUpd==0) 
				...
				if !lNMenu
					...
					APMsgAlert(AllTrim(_cRetUpd),"Atualização da tabela Resumo não realizada!")
