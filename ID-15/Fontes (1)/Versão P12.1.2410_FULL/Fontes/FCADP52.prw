...
Static Function MenuDef()
	...
	//Adicionando opções
	ADD OPTION aRot TITLE 'Manutenção'    ACTION 'U_XCADP52(4)' OPERATION 6 ACCESS 0 //OPERATION 4
	ADD OPTION aRot TITLE 'Selecione'    ACTION 'U_P52SELCC()' OPERATION 6 ACCESS 0 //OPERATION 4
	ADD OPTION aRot TITLE 'Carga'    ACTION 'U_FCARP52()' OPERATION 6 ACCESS 0 //OPERATION 4
	ADD OPTION aRot TITLE 'Excluir'    ACTION 'U_XCADP52(5)' OPERATION 6 ACCESS 0 //OPERATION 5
...
static function PosVldLine(oModel)
	...
	For nX := 01 To oModel:Length()
		...
		if oModel:IsUpdated() .Or. oModel:IsInserted()
			...
			FwFldPut("P52_XUSR", UsrRetName(RetCodUsr()))
		endif
