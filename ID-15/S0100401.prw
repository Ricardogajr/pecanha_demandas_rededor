...
Static Function ViewDef()
	...
	oStruSC7p:AddField("C7_XAGEPOR", "28", "Agência", "Agência", , "C", "@!", , ""     , .F., "01", , , , , .F., , ,  )
	oStruSC7p:AddField("C7_XDVAPOR", "29", "DV Agência", "DV Agência", , "C", "@!", , ""     , .F., "01", , , , , .F., , ,  )
...
Static Function ExcluiNota(nRecno, cTipoSp)
	...
	if lMsErroAuto
		...
		U_EXCTITNFE(SC7->C7_FILIAL, SC7->C7_XDOC, SC7->C7_FORNECE, SC7->C7_LOJA, SC7->C7_XSERIE)//Mantem essa chamada para excluir os titulos de NFE legado.
	endif
...
User Function STRATAXS()
	...
	if FWIsInCallStack("U_RDCAR02")
		...
		oModel:SetErrorMessage(oModel:GetId(),"C7_XSERIE" , oModel:GetId(), "C7_XSERIE", "Help", "Não é permitido digitar série com espaço a esquerda!", , )
		Return .F.
	EndIf
