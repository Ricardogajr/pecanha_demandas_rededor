...
Static Function fImpTabela()
	...
	ElseIf cTabela == "SC7"
		if SubStr(cValToChar(aRet[8]),1,1) $ "1|Nova base"
	...
	If lRegra
		...
		Case cTabela == "SC7"
			...
			if cValToChar(aRet[8]) $ "1|Nova Base"
				cSQL += " LEFT JOIN "+ RetSqlName("P17")+"  P17" + CRLF
				cSQL += " ON P17.D_E_L_E_T_ = ' '" + CRLF
				cSQL += " AND P17.P17_FTRATA = "+Replace(cTabelaAlias, "_1", "_2")+ ".C7_FILIAL" + CRLF
				cSQL += " AND P17.P17_COD = "+Replace(cTabelaAlias, "_1", "_2")+ ".C7_PRODUTO" + CRLF
			endif
