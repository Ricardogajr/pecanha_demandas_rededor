...
Alterações: Thais Paiva - 24876807 - Alterações para o correto funcionamento na Release 2410
*/
...
Private cArqCSV     := ""
Private cArqRCG     := ""
Private cDirArq     := getTempPath() //"" Thais Paiva - 24876807
Private cLog        := ""
...
//cArqCSV := tFileDialog( cTipArq, cTitulo, , cDirArq, .F.) Thais Paiva - 24876807
cArqCSV := tFileDialog( cTipArq, cTitulo,, cDirArq, .T.)
   
If Empty(Alltrim(cArqCSV))
