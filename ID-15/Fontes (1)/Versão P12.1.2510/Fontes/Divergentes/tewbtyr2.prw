...
// ------------------------------------
	...
	oPrint:Say( _nLinha , 600 , OemToAnsi( 'CNPJ/CPF: '    + transform( cA2CGC , PesqPict( 'SA2' , 'A2_CGC' ) )                   ) , oFont11 )
	_nLinha := fPulaLinha()
// ------------------------------------
	oPrint:Say( _nLinha , 015 , OemToAnsi( 'CNPJ/CPF: '    + transform( alltrim( SM0->M0_CGC ) , PesqPict( 'SA2' , 'A2_CGC' ) )     ) , oFont11 )
