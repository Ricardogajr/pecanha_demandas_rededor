...
Static Function PegSuper(oSolicVag)
	...
	If aAprov[1][1] //Encontrou aprovador
		...
		Else //EFETIVAÇAO
			...
			//Ajustado dia 30/10/2025 por Laura Peghini - Conforme solicitado no email [TEC_RH - PORTAL DE VAGAS] MUDANÇA DE MENSAGEM dia 29/10/2025
			cLcFap := Alltrim(POSICIONE("PA2",6, RH3->RH3_FILIAL + RH3->RH3_CODIGO, "PA2_XORIGE"))
