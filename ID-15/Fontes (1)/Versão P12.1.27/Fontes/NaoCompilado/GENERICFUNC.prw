...
User Function CriaArray(tabela)
	...
	For nX := 1 to Len(aFields)
		...
		If GetSx3Cache(aFields[nX],"X3_CAMPO") <> NIL
			...
			Aadd(aStru, {SGetSx3Cache(aFields[nX],"X3_CAMPO"),GetSx3Cache(aFields[nX],"X3_TIPO"),GetSx3Cache(aFields[nX],"X3_TAMANHO"),GetSx3Cache(aFields[nX],"X3_DECIMAL")})
	    	//Endif
	//Fim - Thais Paiva - Compatibilização P27
	   Endif
	Next nX
