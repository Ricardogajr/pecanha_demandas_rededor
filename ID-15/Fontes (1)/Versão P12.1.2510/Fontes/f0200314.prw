...
User Function F0200314()
	...
	If oSolic:ValAprSol(cMat,cFil,cSolic,cFilis)
		If oSolic:lVALAPRSOLRESULT
			...
			If oOrg:GetStructure()
				...
				If cStatus == "1" //APROVADO
					If oParam:PegSuper(cMat, cSolic, '1',cFilis, cObs)
						cMsg := oParam:OWSPegSuperRESULT:cMsgAvso//"Aprovado com sucesso."
					EndIf
				Else //REPROVADO
					If oParam:PegViInv(cMat,cSolic,'1', cFilis, cObs, cfil, cMat)
