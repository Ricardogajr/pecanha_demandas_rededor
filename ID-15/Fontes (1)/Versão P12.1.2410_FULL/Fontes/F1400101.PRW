...
User Function F1400101()
	...
	Local cAliasLog := "SC7,CT1,SA2,SAH,SB1,SBM,SED,P13,P14,P15,P16,P17,P24,P25,SA1,CVD,CVE,CVF,FIL,SE4,P32,SBZ,SF4,CTT,CTS,CTD,SEJ,SEB,LHT,SNG,CCQ,SC1,SD1,ACV,SF1,P11,NNR"
...
//Lucas Miranda de Aguiar - 29/12/2022 INICIO
 ...
 If lLogado
	If !IsBlind() .And. !IsInCallStack("U_REDA4SEL") .And. !IsInCallStack("MATA235") .And. !IsInCallStack("MATA103") .And. !IsInCallStack("MATA140") .And. !IsInCallStack("MATA094") .And. !IsInCallStack("U_XMATA094")
		If cAlias == "SC7" .And. !INCLUI .And. !ALTERA .And. !IsInCallStack("U_REDA4SEL") .And. !IsInCallStack("MATA235") .And. !IsInCallStack("MATA103") .And. !IsInCallStack("MATA140") .And. !IsInCallStack("MATA094") .And. !IsInCallStack("U_XMATA094")
			Return
		EndIf

		If cAlias == "SC7" .And. ALTERA .And. !IsInCallStack("U_REDA4SEL") .And. !IsInCallStack("MATA235") .And. !IsInCallStack("MATA103") .And. !IsInCallStack("MATA140") .And. !IsInCallStack("MATA094") .And. !IsInCallStack("U_XMATA094")
			Return
		EndIf
	EndIf
EndIf
